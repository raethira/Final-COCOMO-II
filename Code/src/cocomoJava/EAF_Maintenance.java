...
/**This class implements the Effort Adjustment Factor(EAF) for Maintenance
 * @author shriraksharao
 */
public class EAF_Maintenance extends javax.swing.JDialog {
    ...
    Maintenance_Mod_secondpage cocoDash1;
    private String[] eafRating;
    private static DecimalFormat df2 = new DecimalFormat(".##");
    public static double netEaf;
    public static double rely, data, docu, cmplx,
     ...
     */
    public EAF_Maintenance(java.awt.Frame parent, boolean modal, String[] eafRating) {
        super(parent, modal);
        initComponents();
        this.getContentPane().setBackground(Color.white);
        
        this.cocoDash1 = (Maintenance_Mod_secondpage) parent;
        netEaf = 1.00;
    ...
    private void initComponents() {
        ...
        jEafOk.setBackground(new java.awt.Color(102, 204, 255));
        ...
        jEafCancel.setBackground(new java.awt.Color(102, 204, 255));
        ...
        eafNote.setText("(Schedule is not used in Maintenence Calculation)");
    ...
    private void jEafOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jEafOkActionPerformed
        ...
        this.cocoDash1.setEafbutton(String.valueOf(df2.format(netEaf)), eafRating);
        this.setVisible(false);

    }//GEN-LAST:event_jEafOkActionPerformed
    private void getEAFSettingValues(){
        data = EAFDefault_Maintenance.data[dataCombo.getSelectedIndex()];
        docu = EAFDefault_Maintenance.docu[docuCombo.getSelectedIndex()];
        cmplx = EAFDefault_Maintenance.cplx[cmplxCombo.getSelectedIndex()];
        pvol = EAFDefault_Maintenance.pvol[pvolCombo.getSelectedIndex()];
        rely = EAFDefault_Maintenance.rely[relyCombo.getSelectedIndex()];
        reuse = EAFDefault_Maintenance.ruse[reuseCombo.getSelectedIndex()];
        time = EAFDefault_Maintenance.time[timeCombo.getSelectedIndex()];
        stor = EAFDefault_Maintenance.stor[storCombo.getSelectedIndex()];
        pcon = EAFDefault_Maintenance.pcon[pconCombo.getSelectedIndex()];
        apex = EAFDefault_Maintenance.apex[apexCombo.getSelectedIndex()];
        ltex = EAFDefault_Maintenance.ltex[ltexCombo.getSelectedIndex()];
        acap = EAFDefault_Maintenance.acap[acapCombo.getSelectedIndex()];
        pcap = EAFDefault_Maintenance.pcap[pcapCombo.getSelectedIndex()];
        plex = EAFDefault_Maintenance.plex[plexCombo.getSelectedIndex()];
        site = EAFDefault_Maintenance.site[siteCombo.getSelectedIndex()];
        tool = EAFDefault_Maintenance.tool[toolCombo.getSelectedIndex()];
    ...
    private void toolComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_toolComboActionPerformed
     ...
     public static void calculateEaf() {
